...
- [Postęp: <picture> <source media="(prefers-color-scheme: dark)" srcset="https://latex.codecogs.com/svg.image?\inline&space;\tiny&space;\color{white}25\frac{0}{1}\%"> <img alt="25 0\1%" src="https://latex.codecogs.com/svg.image?\inline&space;\tiny&space;&space;25\frac{0}{1}\%"> </picture>](#postęp----)
- [Cele](#cele-)
...
## Postęp: <picture> <source media="(prefers-color-scheme: dark)" srcset="https://latex.codecogs.com/svg.image?\inline&space;\color{white}25\frac{0}{1}\%"> <img alt="25 0\1%" src="https://latex.codecogs.com/svg.image?\inline&space;&space;25\frac{0}{1}\%"> </picture>
